...
int main(int argc, char* argv[]) {
    ...
    bbqLayerSettings.source.buffer.buffer = createImageFromFile(
        "./raw/20251213_185527/@0@layer@94@3000x2120_bpp_1.raw",
         3000,
         2120);
    bbqLayerSettings.alpha = 0.759766f;
    ...
    launcherLayerSettings.name = "com.android.launcher.Launcher#112233";
    launcherLayerSettings.source.buffer.buffer = createImageFromFile(
        "./raw/20251213_185527/@1@layer@112233@3000x2120_bpp_1.raw",
            3000,
            2120);
    launcherLayerSettings.alpha = 1.0f;
    launcherLayerSettings.sourceDataspace = ui::Dataspace::HAL_DATASPACE_DISPLAY_P3;

    launcherLayerSettings.geometry.boundaries = ui::FloatRect(0, 0, 3000, 2120);
    launcherLayerSettings.geometry.roundedCornersCrop = ui::FloatRect(0, 0, 3000, 2120);
    ...
    renderengine::LayerSettings task2520LayerSettings;
    task2520LayerSettings.name = "Task=2520#112813";
    task2520LayerSettings.alpha = 1.0f;
    task2520LayerSettings.sourceDataspace = ui::Dataspace::HAL_DATASPACE_V0_SRGB;

    task2520LayerSettings.geometry.boundaries = ui::FloatRect(0.000000, 0.000000, 1708.000000, 961.000000);
    task2520LayerSettings.geometry.roundedCornersCrop = ui::FloatRect(0.000000, 0.000000, 1708.000000, 961.000000);
    task2520LayerSettings.geometry.roundedCornersRadius = {53.0, 53.0};
    task2520LayerSettings.geometry.positionTransform = SkM44 {
        0.8116,  0.0000,  0.0000,  1542.0000,
        0.0000,  0.8116,  0.0000, 694.0000,
        0.0000,  0.0000,  1.0000,  0.0000,
        0.0000,  0.0000,  0.0000, 1.0000
    };

    task2520LayerSettings.shadow.length = 200.000000f;
    task2520LayerSettings.shadow.boundaries = ui::FloatRect(0.000000, 0.000000, 1708.000000, 961.000000);

    task2520LayerSettings.source.solidColor = SkV3{-1.0f, -1.0f, -1.0f};

    layers.push_back(task2520LayerSettings);

    renderengine::LayerSettings gameLayerSettings;
    gameLayerSettings.name = "com.supercell.titan.tencent.GameAppTencent";
    gameLayerSettings.source.buffer.buffer = createImageFromFile(
        "./raw/20251213_185527/@2@layer@112877@1386x780_bpp_1.raw",
            1386,
            780);
    gameLayerSettings.alpha = 1.0f;
    gameLayerSettings.sourceDataspace = ui::Dataspace::HAL_DATASPACE_V0_SRGB;

    gameLayerSettings.geometry.boundaries = ui::FloatRect(0, 0, 1708, 961);
    gameLayerSettings.geometry.roundedCornersCrop = ui::FloatRect(0, 0, 1708, 961);
    gameLayerSettings.geometry.roundedCornersRadius = {53.0, 53.0};
    gameLayerSettings.geometry.positionTransform = SkM44 {
        0.8116,  0.0000,  0.0000,  1542.0000,
        0.0000,  0.8116,  0.0000,  694.0000,
        0.0000,  0.0000,  1.0000,  0.0000,
        0.0000,  0.0000,  0.0000,  1.0000
    ...
    layers.push_back(gameLayerSettings);
    ...
    statusBarLayerSettings.source.buffer.buffer = createImageFromFile(
        "./raw/20251213_185527/@5@layer@88@3000x84_bpp_1.raw",
            3000,
            84);
