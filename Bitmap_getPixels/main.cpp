...
void draw(SkCanvas* canvas) {
    ...
    bitmap.allocPixels();
    // set unpremultied color value
    bitmap.eraseColor(0x80808080);
    void* baseAddr = bitmap.getPixels();
    // we will get premultied color value
    SkDebugf("baseAddr vaule = %0x\n", *(SkPMColor*)baseAddr);
    *(SkPMColor*)baseAddr = 0xFFFFFFFF;
    // getColor will get the unpremultied color value
    SkDebugf("bitmap.getColor(0, 1) = %0x %c= 0x00000000\n", bitmap.getColor(0, 1),
