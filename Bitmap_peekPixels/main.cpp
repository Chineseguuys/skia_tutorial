...
#if 0
    saveBitmapAsPng(bitmap, generate_filename("offscreen", "png").c_str());
#endif
}
...
void draw1(SkCanvas* canvas) {
    ...
    SkDebugf("src pixels[%0x] %c= sub pixels [%0x]\n", source.getPixels(), source.getPixels() == subset.getPixels() ? '=' : '!', subset.getPixels());
    SkDebugf("src addr[%0x] %c= sub addr[%0x]\n", source.getAddr(32, 64),
...
/*
src ref == sub ref
src pixels[3f1eb010] != sub pixels [3f20b090]
src addr[3f20b090] == sub addr[3f20b090]
*/
}
