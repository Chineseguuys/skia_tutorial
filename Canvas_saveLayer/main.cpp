...
// https://fiddle.skia.org/c/@Canvas_saveLayer
...
// https://fiddle.skia.org/c/@Canvas_saveLayer_2
void draw1(SkCanvas* canvas) {
    SkPaint paint, blur;
    blur.setImageFilter(SkImageFilters::Blur(3, 3, nullptr));
    canvas->saveLayer(SkRect::MakeWH(120, 120), &blur);
    SkRect rect = { 25, 25, 50, 50};
    canvas->drawRect(rect, paint);
    canvas->translate(50, 50);
    paint.setColor(SK_ColorRED);
...
// https://fiddle.skia.org/c/@Canvas_saveLayer_3
