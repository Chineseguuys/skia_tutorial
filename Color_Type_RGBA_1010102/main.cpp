...
// https://fiddle.skia.org/c/@Color_Type_RGBA_1010102
void draw(SkCanvas* canvas) {
    ...
    auto pack1010102 = [](unsigned int r, unsigned int g, unsigned int b, unsigned int a) -> uint32_t {
        return (r << 0) | (g << 10) | (b << 20) | (a << 30);
    };

    uint32_t redBits[] =  { pack1010102(0x3FF, 0x000, 0x000, 0x0),
                            pack1010102(0x2ff, 0x000, 0x000, 0x0),
                            pack1010102(0x1ff, 0x000, 0x000, 0x0),
                            pack1010102(0x0ff, 0x000, 0x000, 0x0) };
    uint32_t blueBits[] = { pack1010102(0x000, 0x000, 0x3FF, 0x0),
                            pack1010102(0x000, 0x000, 0x2ff, 0x0),
                            pack1010102(0x000, 0x000, 0x1ff, 0x0),
                            pack1010102(0x000, 0x000, 0x0ff, 0x0) };
