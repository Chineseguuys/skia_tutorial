...
// https://fiddle.skia.org/c/@Canvas_drawRect
...
// https://fiddle.skia.org/c/@Canvas_drawRegion
...
void draw3(SkCanvas *canvas) {
    SkRegion region;
    region.op({10, 20, 90, 90}, SkRegion::kReplace_Op);
    region.op({30, 50, 110, 110}, SkRegion::kXOR_Op);
    region.op({50, 10, 140, 70}, SkRegion::kXOR_Op);
    SkPaint paint;
    paint.setAntiAlias(true);
...
void draw4(SkCanvas *canvas) {
    SkRegion region;
    region.op({10, 20, 90, 90}, SkRegion::kReplace_Op);
    region.op({30, 50, 110, 110}, SkRegion::kDifference_Op);
    //region.op({50, 10, 140, 70}, SkRegion::kDifference_Op);
    SkPaint paint;
    paint.setAntiAlias(true);
    paint.setStyle(SkPaint::kFill_Style);
    paint.setStrokeWidth(4);
...
void draw5(SkCanvas *canvas) {
    SkRegion region;
    region.op({10, 20, 90, 90}, SkRegion::kReplace_Op);
    region.op({30, 50, 110, 110}, SkRegion::kReverseDifference_Op);
    //region.op({50, 10, 140, 70}, SkRegion::kDifference_Op);
    SkPaint paint;
    paint.setAntiAlias(true);
    paint.setStyle(SkPaint::kFill_Style);
