...
// https://fiddle.skia.org/c/@Canvas_rotate
void draw(SkCanvas* canvas) {
    ...
    canvas->save();
    canvas->rotate(10.0f * 360 / 60);   // 10 minutes of 60 scaled to 360 degrees
